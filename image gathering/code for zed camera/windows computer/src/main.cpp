...
/********************************************************************************
 ** grab images and change the camera settings **
 ** with the ZED SDK                                                           **
 ********************************************************************************/
...
int main(int argc, char** argv) {
    ...
    while (l<10) {
        ...
        if (returned_state == ERROR_CODE::SUCCESS) {
            ...
            string test = to_string(l);
            string t = "image" + test + ".png";
            cv::String win_name2 = t;
             cv::imwrite(win_name2, cvImage, compression_params);
            //std::sleep(20);
